...
{
    public class SqlDeleteStrategy : SqlStrategyBase
    {
        public SqlDeleteStrategy(Type ModelType)
            : base(ModelType)
        {
        }

        public SqlDeleteStrategy(Type ModelType, IModelStrategy ModelStrategy)
            : base(ModelType, ModelStrategy)
        {
        }
