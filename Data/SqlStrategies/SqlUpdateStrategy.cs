...
{
    public class SqlUpdateStrategy : SqlStrategyBase, 
        ISqlQueryIncrementalStrategy, 
        ISqlQueryDecrementalStrategy
    {
        public SqlUpdateStrategy(Type ModelType)
            : base(ModelType)
        {
        }

        public SqlUpdateStrategy(Type ModelType, IModelStrategy ModelStrategy) : base(ModelType, ModelStrategy)
        {
        }
