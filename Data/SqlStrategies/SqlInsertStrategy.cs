...
{
    public class SqlInsertStrategy : SqlStrategyBase
    {
        public SqlInsertStrategy(Type ModelType)
            : base(ModelType)
        {
        }

        public SqlInsertStrategy(Type ModelType, IModelStrategy ModelStrategy)
